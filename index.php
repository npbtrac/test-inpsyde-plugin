...
$config = array(
	...
	'services'    => array(
		View_Service::class => array(
			'text_domain' => $text_domain,
		),
	),
);

register_activation_hook( __FILE__, array( Test_Inpsyde::class, 'activate_plugin' ) );
register_deactivation_hook( __FILE__, array( Test_Inpsyde::class, 'deactivate_plugin' ) );
